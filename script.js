    ...
    const puzzles = [
        {
            ...
            <div class="puzzle">
                ...
                <p class="cipher-text">"QEB NXOBO FP KLP NBK PBZOBQ"</p>
            ...
            `,
            answer: "THE ORDER IS A NEW SECRET",
        ...
        },
        {
            ...
            <div class="puzzle">
                ...
                <input type="text" id="puzzle-input" class="puzzle-input" placeholder="Enter the odd one out (e.g., Eagle)">
                <button class="btn submit-btn">Submit Answer</button>
            </div>
            `,
            answer: "WOLF",
            hint: "The symbols represent the four sons of Horus. One of these animals is not typically found on canopic jars. (Human, Baboon, Falcon, Jackal)."
        },
        {
            ...
            <div class="puzzle">
                ...
                <p class="cipher-text">4, 1, 3, 3, 5, 2</p>
                <p class="puzzle-text">"Take the fourth letter from the Scribe's answer. The first from the Sphinx's. The third from the Impostor Jar. The third again. The fifth from the Scribe's. The second from the Sphinx's."</p>
                <input type="text" id="puzzle-input" class="puzzle-input" placeholder="Enter the final password">
                <button class="btn submit-btn">Submit Answer</button>
            </div>
            `,
            answer: "ESCAPE", // O from ORDER, M from MAP, L from WOLF, L from WOLF, R from ORDER, A from MAP
            hint: "Recall your answers to the previous puzzles. The Scribe's was 'THE ORDER...'. The Sphinx's was 'MAP'. The Impostor Jar was 'WOLF'."
        }
    ];
